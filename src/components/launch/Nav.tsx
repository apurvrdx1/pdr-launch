    ...
    <>
      <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <a
              href="#access"
              className="group hidden items-center gap-2 rounded-full bg-gold py-2 pl-5 pr-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-ink transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:bg-gold-deep active:scale-[0.98] sm:flex"
            >
              Request access
      ...
      >
        ...
        <a
          ...
          className={`mt-8 w-max rounded-full bg-gold px-7 py-3.5 text-[12px] font-semibold uppercase tracking-[0.2em] text-ink transition-all duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${
            open ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
