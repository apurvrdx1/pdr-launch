...
export default function HowItWorks() {
  return (
    <section id="how" className="bg-ink-deep py-28 md:py-36">
      <div className="mx-auto max-w-[1400px] px-6 md:px-12 lg:px-20">
        ...
        <div className="mt-16 grid grid-cols-1 gap-px overflow-hidden rounded-[2rem] ring-1 ring-white/10 md:grid-cols-3">
          {STEPS.map((step, i) => (
            <Reveal
              key={step.no}
              delay={i * 110}
            ...
            >
              <span className="font-display text-6xl text-white/10">{step.no}</span>
